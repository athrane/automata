 ...
 *
 * The grid is toroidal: neighbor coordinates that run past an edge wrap
...
export class SumRule implements Rule {
   ...
   *
   * Neighbor coordinates wrap around the grid edges, so every cell has
   * the full 8-neighbour Moore neighbourhood regardless of its position.
   *
